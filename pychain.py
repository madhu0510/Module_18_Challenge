...
if st.button("Add Block"):
    ...
    # and `amount` values
    new_block = Block(
        #record = Record(sender=input_sender, receiver=input_receiver, amount=input_amount),     # Not working
        record = Record(sender=input_sender, receiver=input_receiver, amount=float(input_amount)),     # Not working
        #record = {'sender':input_sender, 'receiver': input_receiver, 'amount':input_amount},     #Not Working
        creator_id=42,
